...
.. tab:: Linux, MacOS, Windows (WSL)
    ...
    .. code-block:: bash
        ...
        curl -O https://esa.gitlab.io/pyxel/doc/latest/pyxel-1.10.1-environment.yaml
        conda env create -f pyxel-1.10.1-environment.yaml

.. tab:: Windows (Powershell)

    .. code-block:: bash

        wget https://esa.gitlab.io/pyxel/doc/latest/pyxel-1.10.1-environment.yaml -outfile "pyxel-1.10.1-environment.yaml"
        conda env create -f pyxel-1.10.1-environment.yaml
