...
- **Sampling mode**: the pipeline is run N times incrementing time, saving detector attributes (simulation of non-destructive readout mode, and time-dependent effects)
