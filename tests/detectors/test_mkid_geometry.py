...
def test_create_valid_geometry(
    ...
    """Test when creating a valid `MKIDGeometry` object."""
    _ = MKIDGeometry(
        row=row,
        col=col,
...
@pytest.mark.parametrize(
    ...
    [
        ...
        pytest.param(MKIDGeometry(), False, id="Empty 'Geometry'"),
        pytest.param(MKIDGeometry(row=100), False, id="Only one parameter"),
        pytest.param(
            Geometry(
                row=100,
                col=120,
