...
@pytest.mark.parametrize(
    ...
    [
        ("float", ValueError, "Expecting a signed/unsigned integer"),
        ("float32", ValueError, "Expecting a signed/unsigned integer"),
        ("float64", ValueError, "Expecting a signed/unsigned integer"),
