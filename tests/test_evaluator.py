...
@pytest.mark.parametrize('expr, exp', [
    ('[1,2,3]', [1,2,3]),
    ([1,2,3], [1,2,3]),
    ('numpy.array([1,2,3])', [1,2,3]),
    ('numpy.array([1,2,3], dtype=float)', [1.,2.,3.]),
    ('numpy.array([1,2,3], dtype=numpy.float64)', [1.,2.,3.]),
...
@pytest.mark.parametrize('expr, exp_exc, exp_msg', [
    ("numpy.array([1,2,3], dtype=numpy.float32)", NotImplementedError, "numpy data type is not a float or int"),
    ("numpy.array([1,2,3], dtype=numpy.uint64)", NotImplementedError, "numpy data type is not a float or int"),
